...
export const dict: Dict = {
  ...
  "admin.orders.print": { ar: "طباعة الفاتورة", en: "Print invoice" },
  "admin.orders.invoice": { ar: "فاتورة", en: "Invoice" },
  "admin.orders.dateShort": { ar: "التاريخ", en: "Date" },
  "admin.orders.payMethod": { ar: "طريقة الدفع", en: "Payment method" },
  "admin.orders.totalItems": { ar: "الإجمالي", en: "Total" },
  "admin.orders.receiptFooter": {
    ar: "شكرًا لثقتكم في سلام",
    en: "Thank you for choosing SALAM",
  },
